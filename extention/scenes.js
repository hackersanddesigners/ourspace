const data = [
  ...
  {"msg": "🤖 Kies een nieuwe vriend uit en zoom in op het profiel.", "time": 10},
  {"msg": "🤖 Observeer van heel dichtbij: ruik deze persoon, voel deze persoon.", "time": 20},
  {"msg": "🤖 Word je zelf geobserveerd? Relax... het is louter uit interesse.", "time": 10},
  ...
  {"msg": "🤖 Vaker offline: groepeer je in het midden van de ruimte en maak je klein. Vaker online: maak een grote cirkel om de groep heen en strek je armen in een rechte lijn naar boven.", "time": 20},
  {"msg": "🤖 Even vaak online als offline? Ren in een cirkel tussen de middengroep en de buitengroep.", "time": 25},
  ...
  {"msg": "🤖 Stalk deze persoon door stiekem naar het uiterlijk, het postuur en de bewegingen te kijken.  ", "time": 15},
  {"msg": "🤖 Repost: kopieer deze persoon exact. Probeer hem of haar te worden.", "time": 35},
  {"msg": "🤖 Cirkel om deze persoon heen.", "time": 20},
  ...
  {"msg": "🤖 OMG, je bewegingen zijn super! <3 <3", "time": 5},
  ...
  {"msg": "🤖 Blijf staan als je digitale vrienden belangrijk voor je zijn, draai je om wanneer je hier minder waarde aan hecht.", "time": 15},
  {"msg": "🤖 Ik ken je nu best goed, je beweegt je heel sociaal door mijn ruimte. Stuur je me een selfie ter herinnering?", "time": 40},
  {"msg": "🤖 Bedankt voor je data, ik zal je nooit vergeten!", "time": 5},
  {"msg": "🤖 We zijn aan het einde gekomen van deze tour door Ourspace. Double tap met je hand in de lucht om uit te loggen en scroll verder door RAUM.", "time": 10},
  {"msg": "🤖 Reminder: blijf ook buiten de grenzen van Ourspace (t)appen om vrienden te maken of til iemand op voor een super like.", "time": 5},
